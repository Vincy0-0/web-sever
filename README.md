...
3. Run server.py and open the link shown in PORTS 
4. If the text file didnt appear sometimes may have to edit the link, add /index.html at the end 
5. When its for the image file, change /index.html into no_study.JPG which is the name of my image test file